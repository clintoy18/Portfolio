  ...
  return (
    <section id="contact" className="py-24 border-t border-gray-200">
      <div className="container mx-auto px-6 max-w-4xl">
        <h2 className="text-4xl font-light text-center text-gray-800 mb-16">Let's Connect</h2>
        ...
        >
          <form className="space-y-8">
            ...
            />
            <button className="w-full py-4 bg-gray-900 text-white rounded-xl hover:bg-gray-800 transition font-medium">
              Send Message
            </button>
          </form>

          <div className="mt-10 pt-8 border-t border-gray-200 text-center text-gray-600">
            <p>clint@example.com • +63 912 345 6789</p>
          </div>
        </motion.div>
      </div>
    </section>
